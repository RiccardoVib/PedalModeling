...
for l in range(len(sig_name)):
    ...
    wavfile.write(tar_dir, int(fs), audio_tar)
...
#     plot_time(audio_tar, audio_pred, audio_inp, fs, data_dir, 'Dense' + sig_name[l])
#     plot_fft(audio_tar, audio_pred, audio_inp, fs, data_dir, 'Dense' + sig_name[l])
